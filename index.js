...
// ANSWER:
no because you are always looking for the 4th Element. You could make the function run fast, but it would still be the same time complexity.
...
// ANSWER: 
countLetters: splitString creates a new array based on how long the string passed in was 
countLettersRoundTwo: because .replace does not change the original value, a new value for the str variable based on the original string length
